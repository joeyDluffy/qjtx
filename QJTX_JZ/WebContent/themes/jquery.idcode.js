...
(function($){
	...
	$.idcode = {
		...
		setCodeId:function(id) {
			settings.e=id;
			_set.storeLable = 'codeval-'+id;
			_set.store = '#ehong-code-input-' + id;
			_set.codeval = '#ehong-code-'+id;
		}
	};
	...
	function _setCodeStyle(eid, codeType, codeLength){
		...
		var htmlCode=''
		if(!settings.inputID){
			htmlCode='<span><input id="ehong-code-input-'+settings.e+'" type="text" maxlength="4" /></span>';
		}
		htmlCode+='<div id="ehong-code-'+settings.e+'" class="ehong-idcode-val ehong-idcode-val';
