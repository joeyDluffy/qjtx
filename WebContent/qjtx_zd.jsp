...
<html>
	<head>
		...
		<script type="text/javascript" src="qjtx_zd.js?v=0622ss"></script>
	...
	<body>
		...
		<div style="position:fixed; top:0; left: 0;width: 100%; height: 40px; background: #FFFAB4;">
			...
			<div role="main" class="qj_content">
				...
				<div class="saleImgDown" style="height:60px; padding-top:10px;">
				...
				<div class="saleImg" id ="imageshow">
 				...
 				<div class="sys_item_spec" style="width: 100%; border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; float: left;"> 
